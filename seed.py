...
def generate_tags():
    for i in range(tag_count):
        tag_name = "".join(choices(ascii_letters, k=randint(4, 10)))
...
def generate_recipes():
    for i in range(recipe_count):
        title = "".join(choices(ascii_letters, k=randint(15, 50)))
        ...
        for j in range(randint(0, 6)):
            ...
            try:
                ...
                # recipe might already have this tag
                pass
